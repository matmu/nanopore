...
RUN gdown https://drive.google.com/uc?id=1sQ7-XbOqCvq7FeXGWYA_Yw7xRcmJ-I5B -O /opt/Homo_sapiens.GRCh38.dna.primary_assembly.tar.gz && tar xzf /opt/Homo_sapiens.GRCh38.dna.primary_assembly.tar.gz -C /opt && rm /opt/ && /opt/Homo_sapiens.GRCh38.dna.primary_assembly.tar.gz
